...
Cocoa勉強会 関西の資料。ダウンロードできるZIPの中にPDFの資料とサンプルコードがあります。ひと通りの機能がコンパクトな資料にまとめられており、大変わかりやすいです。この資料に目を通してからプログラミングガイドを読むとスムーズだと思います。  
書籍を出版されるそうで楽しみです！
...
Xcode 5のSpriteKit Gamesテンプレートの解説。行ごとに説明があります。
